package prjava43casado20;
import java.awt.*; // using AWT containers and components
import java.awt.event.*; // using AWT events and listener interfaces
// An AWT GUI program inherits the top-level container java.awt.Frame
public class Prjava43casado20 extends Frame
...
setTitle("prjava43cognom20"); // "this" Frame sets title
setSize(250, 100); // "this" Frame sets initial size
setVisible(true); // "this" Frame shows
}
/** The entry main() method */
public static void main(String[] args) {
new Prjava43casado20(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
